function [BB, a_k, W, V] = IDDL_S(X_train, X_test, train_labels, test_labels, params)
    ...
    fprintf('Initialization : Test Accuracy IDDL_S = %0.2f\n', acc_test);
    fprintf('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n')
    % Optimization Loop
    for iter = 1:params.iter
        ...
        a_k = Update_ABLD_param_S(X_train, a_k, W, params.lam, BB, H);
        fprintf('alpha = %0.3f | beta = %0.3f\n', a_k(1), a_k(2))
        fprintf('Updating Classifier...\n')
        W = Update_W_ABLD(X_train, BB, params.lam,H, a_k);
        [~, acc_test] = perf_check_ABLD(X_train, X_test, BB, train_labels, test_labels, W, a_k);
        fprintf('iter = %d : Test Accuracy IDDL_S = %0.2f\n', iter, acc_test);
        fprintf('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\n')
    end
