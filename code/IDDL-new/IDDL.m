...
%
function [B, alphabeta, W, V] = IDDL(X_train, X_test, train_labels, test_labels, params)
    lam = params.lam;
    ...
    % init B
    B = initialize_atoms(X, train_labels, num_atoms)';
    ...
    function obj = objective(B, W, alpha, beta)
        ...
        %     end
        % end
        V = update_V(V, X, B, alpha, beta, n, num_atoms);
        obj = RRL(H, W, V, lam);
